    ...
    public void loop()  {
        ...
        switch (positionDetect) {
            case 1:
                ...
                .lineToConstantHeading(new Vector2d(-51, -45))
                    ...
                    .lineToConstantHeading(new Vector2d(51.50, -25))
            ...
            case 3:
                ...
                TrajectorySequence trajR = drive.trajectorySequenceBuilder(startPoseR)
                        ...
                        .lineToLinearHeading(new Pose2d(-35, -36, Math.toRadians(-140)))
                        ...
                        .lineToConstantHeading(new Vector2d(45, -57))
                        .lineToConstantHeading(new Vector2d(50.00, -37))

                        .addDisplacementMarker(() -> {
                            backPixelDrop.setPosition(0.78);
                        })

                        .lineToConstantHeading(new Vector2d(51, -37))
            ...
            case 2:
                ...
                TrajectorySequence trajM = drive.trajectorySequenceBuilder(startPoseM)
                        ...
                        .lineToConstantHeading(new Vector2d(45, -57))
                        .lineToConstantHeading(new Vector2d(50.00, -31.5))

                        .addDisplacementMarker(() -> {
                            backPixelDrop.setPosition(0.78);
                        })

                        .lineToConstantHeading(new Vector2d(51, -31.5))
